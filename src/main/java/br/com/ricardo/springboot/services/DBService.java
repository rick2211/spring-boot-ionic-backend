...
import br.com.ricardo.springboot.domain.model.*;
import br.com.ricardo.springboot.repositories.*;
...
public class DBService {
    ...
    public void instantiateTestDataBase() throws ParseException {
        ...
        Produto p8 = new Produto(null, "Cadeira", 800.00);
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("1234"));

        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        Cliente cli2 = new Cliente(null, "Ricardo Souza", "rick.souza2211@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("1234"));
